...
public class StudentGoodHash {
    ...
    /**
     * This method works by adding the character values of all characters in the name string.
     * The total number of each character in the first and last name is the same.
     * The hashing algorithm causes conflicts when there is a duplicate uid.
     * The computation is small and efficient.
     *
     * @return the hash code
     */
    public int hashCode() {
//        Initializes the hash with the uid.
//        Add the ASCII value of each character in firstName and lastName to the hash.
        int hash = uid;
